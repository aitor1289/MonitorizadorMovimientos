...
public class UsuarioDaoImpl implements UsuarioDao {
    ...
    List<UsuarioBean> find(UsuarioBean usuarioBean) {
        UsuarioEntity regMovEntity = new UsuarioEntity();
        List<UsuarioBean> regMovBeanList = new ArrayList<>();
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                regMovBeanList.add(regMovTransform.UsuarioEntityToBean(regMovEntity));
    ...
    boolean delete(UsuarioBean usuarioBean) {
        ...
        UsuarioBean UsuarioBean = find(regMovBean).get(0);

        //Eliminamos el registro
        int delete = db.delete("REGISTRO_MOVIMIENTOS", "ID_REG_MOV=" + UsuarioBean.getID_REG_MOV(), null);
    ...
    boolean update(UsuarioBean usuarioBean) {
        ...
        //"ID_REG_MOV", "X", "Y", "Z", "ID_TIPO_MOV", "USUARIOS_ID_USER"
        valores.put("X", UsuarioBean.getX());
        valores.put("Y", UsuarioBean.getY());
        valores.put("Z", UsuarioBean.getZ());
        valores.put("ID_TIPO_MOV", UsuarioBean.getID_TIPO_MOV_DETECT());
        valores.put("USUARIOS_ID_USER", UsuarioBean.getUSUARIOS_ID_USER());

        //Actualizamos el registro en la base de datos
        int update = db.update("REGISTRO_MOVIMIENTOS", valores, "ID_REG_MOV=" + UsuarioBean.getID_REG_MOV(), null);
